...
#define CH2 b00000100
#define CH3 b00001000
#define CH4 b00010000
#define CH5 b00100000
#define CH6 b01000000
#define CH7 b10000000
#define CH8 b00000001
...
const byte mode0_pins[] PROGMEM = {CH2, CH3, CH4, CH5,CH6, 255};//define the names or pin numbers of the given output pins
...
const byte mode1_pins[] PROGMEM = {CH2, CH3, CH4, CH5,CH6, 255};//define the names of the given output pins
...
const byte mode2_pins[] PROGMEM = {CH2, CH3, CH4, CH5,CH6, 255};//define the names of the given output pins
...
const byte mode3_pins[] PROGMEM = {CH2, CH3, CH4, CH5,CH6, 255};//define the names of the given output pins
...
const byte mode4_pins[] PROGMEM = {CH2, CH3, CH4, CH5,CH6, 255};//define the names of the given output pins
...
const byte mode5_pins[] PROGMEM = {CH2, CH3, CH4, CH5,CH6, 255};//define the names of the given output pins
...
const byte mode6_pins[] PROGMEM = {CH2, CH3, CH4, CH5,CH6, 255};//define the names of the given output pins
...
const byte mode7_pins[] PROGMEM = {CH2, CH3, CH4, CH5,CH6, 255};//define the names of the given output pins
...
const byte mode8_pins[] PROGMEM = {CH2, CH3, CH4, CH5,CH6, 255};//define the names of the given output pins
...
const byte mode9_pins[] PROGMEM = {CH2, CH3, CH4, CH5,CH6, 255};//define the names of the given output pins
...
const byte mode10_pins[] PROGMEM = {CH2, CH3, CH4, CH5,CH6, 255};//define the names of the given output pins
...
const byte mode11_pins[] PROGMEM = {CH2, CH3, CH4, CH5,CH6, 255};//define the names of the given output pins
